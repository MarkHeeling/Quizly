...
class UserControllerTest {
        ...
        void testDeleteUser() throws Exception {
                ...
                MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/api/deleteUser/{id}",
                                123L);
                MockMvcBuilders.standaloneSetup(this.userController)
                                .build()
                                .perform(requestBuilder)
        ...
        void testDeleteUser2() throws Exception {
                ...
                user.setUsername("vincent");
                Optional<User> ofResult = Optional.of(user);
                doThrow(new ResourceNotFoundException("?", "?", "Field Value")).when(this.userRepository)
                                .delete((User) any());
                when(this.userRepository.findById((Long) any())).thenReturn(ofResult);
                MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/api/deleteUser/{id}",
                                123L);
        ...
        void testDeleteUser4() throws Exception {
                ...
                doNothing().when(this.userRepository).delete((User) any());
                when(this.userRepository.findById((Long) any())).thenReturn(ofResult);
                MockHttpServletRequestBuilder deleteResult = MockMvcRequestBuilders.delete("/api/deleteUser/{id}",
                                123L);
